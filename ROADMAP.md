...
7. **ChatGPT GPT** — GPT Instructions, Builder configuration, capability policy, conversation starters, nine generated Knowledge bundles, setup/testing/sharing documentation. **Completed** — packaged via `scripts/package-chatgpt-gpt.sh` / `.ps1` into `dist/interview-journey-chatgpt.zip`.
